...
**SQL**
```sql
INSERT INTO `order_export_config` (`property_name`, `name`, `type`, `is_default`, `property_origin`, `post_way`) VALUES ('groupActivityNo', '团购编号', 0, 0, 1, 0);
INSERT INTO `order_export_config` (`property_name`, `name`, `type`, `is_default`, `property_origin`, `post_way`) VALUES ('groupStatus', '团购状态', 0, 0, 1, 0);
